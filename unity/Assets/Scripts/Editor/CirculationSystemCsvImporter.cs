...
public static class CirculationSystemCsvImporter
{
    [MenuItem("VRAnatomy/Import/CirculationSystem CSV -> Database")]
    public static void Import()
    {
        string csvPath = "Assets/Resources/CsvFiles/Project_CirculationSystem_EDatas.csv";
        ...
        var db = ScriptableObject.CreateInstance<CirculationSystemDatabase>();
        ...
        for (int i = 1; i < lines.Length; i++)
        {
            ...
            var e = new CirculationSystemDatabase.Entry
            {
                id = Get(cols, "id"),
        ...
        const string assetPath = "Assets/CirculationSystemDatabase.asset";
