...
public class QuizSelectionManager : MonoBehaviour
{
    ...
    private void OnStartClicked()
    {
        ...
        var introTextObj = introPanel != null ? introPanel.transform.Find("IntroText") : null;
        if (introTextObj != null) introTextObj.gameObject.SetActive(false);

        NavigationState.CurrentQuizCategory = selectedCategory;

        Transform countdownParent = introPanel != null
        ...
        countdown.StartCountdown(countdownParent);
    }
